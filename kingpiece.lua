...
"Seasoned Fishman [Lv. 2200]"
    ...
    if not table.find(Tool, v.Name) then 
...
for _,mob in pairs(game:service'ReplicatedStorage'["MOB"]:GetChildren()) do
	...
	mobB = {}
for _2,mob2 in pairs(game.workspace.Monster.Mon:GetChildren()) do
    if mob2:IsA("Model") and mob2:FindFirstChild("Humanoid") and mob2:FindFirstChild("HumanoidRootPart") then
        table.insert(mobB, mob2.Name)
    end
end
	mobC = {}
for _3,mob3 in pairs(game.workspace.Monster.Boss:GetChildren()) do
    if mob3:IsA("Model") and mob3:FindFirstChild("Humanoid") and mob3:FindFirstChild("HumanoidRootPart") then
        table.insert(mobC, mob3.Name)
    end
end


local ABC;
Tab:AddLabel("if don't have a tool pls unequip tool and execute again")
local ABCD = Tab:AddDropdown("Tool",function(ToolA)
    ABC = ToolA
    Tool = string.split(ABC)
end)
...
_G.Qlvl = ""
_G.Npcpos = 2011.40588, 47.9210663, -1813.2041

local StatsDropDownValue2;
local DD1 = Tab:AddDropdown("Mob",function(MOB)
    StatsDropDownValue2 = MOB
    M = string.split(StatsDropDownValue2)
if MOB == 'Soldier [Lv. 1]' then
	_G.Qlvl = 'QuestLvl1'
	_G.Npcpos = 2011.40588, 47.9210663, -1813.2041
	
	elseif MOB == 'Clown Pirate [Lv. 10]' then
_G.Qlvl = "QuestLvl10"
_G.Npcpos = 2382.96875, 47.9210663, -1669.41541
elseif MOB == 'Clown Pirate [Lv. 50]' then
_G.Qlvl = "QuestLvl50"
_G.Npcpos = 3963.13037, 9.81488895, 178.959442
elseif MOB == 'Commander [Lv. 100]' then
_G.Qlvl = "QuestLvl100"
_G.Npcpos = 1918.89709, 13.3181171, 1183.4646
elseif MOB == 'Fishman [Lv. 180]' then
_G.Qlvl = "QuestLvl180"
_G.Npcpos = 3848.94727, 10.549015, 3331.30884
elseif MOB == 'Trainer Chef [Lv. 250]' then
_G.Qlvl = "QuestLvl250"
_G.Npcpos = -51.5741501, 49.7747345, -88.473381
elseif MOB == 'Dark Leg [Lv. 300]' then
_G.Qlvl = "QuestLvl3000"
_G.Npcpos = 43.1815681, 99.538353, -52.0752106
elseif MOB == 'Snow Soldier [Lv. 400]' then
_G.Qlvl = "QuestLvl400"
_G.Npcpos = -2488.65918, 27.8160839, 1771.52136
elseif MOB == 'Candle Man [Lv. 525' then
_G.Qlvl = "QuestLvl525"
_G.Npcpos = 1806.11365, 10.8593578, 3753.43481
elseif MOB == 'Sky Soldier [Lv. 800]' then
_G.Qlvl = "QuestLvl800"
_G.Npcpos = 248.508698, 2701.8623, 4980.47314
elseif MOB == 'Soldier [Lv. 1000]' then
_G.Qlvl = "QuestLvl1000"
_G.Npcpos = 8298.40332, 11.0420132, 5609.8291
elseif MOB == 'Zombie [Lv. 1500]' then
_G.Qlvl = "QuestLvl1500"
_G.Npcpos = -775.460693, 47.8808746, 8478.74512
elseif MOB == 'New World Pirate [Lv. 1750]' then
_G.Qlvl = "QuestLvl1750"
_G.Npcpos = 8415.6123, 49.7813568, 1083.60693
elseif MOB == 'Rear Admiral [Lv. 1800]' then
_G.Qlvl = "QuestLvl1800"
_G.Npcpos = 8544.45801, 49.7693558, 524.859253
elseif MOB == 'Quake Woman [Lv. 1925]' then
_G.Qlvl = "QuestLvl1925"
_G.Npcpos = 7943.48047, 49.7873611, 625.643005
elseif MOB == 'Fishman [Lv. 2000]' then
_G.Qlvl = "QuestLvl2000"
_G.Npcpos = 2966.18481, 40.321701, 13349.5869
elseif MOB == 'Fishman Soldier [Lv. 2150]' then
_G.Qlvl = "QuestLvl2150"
_G.Npcpos = 3019.50024, 46.1375046, 13886.915
elseif MOB == 'Smoky [Lv. 20]' then
_G.Qlvl = "QuestLvl20"
_G.Npcpos = 2298.73218, 48.3462067, -1855.61157
elseif MOB == 'Tashi [Lv. 30]' then
_G.Qlvl = "QuestLvl30"
_G.Npcpos = 2023.4856, 47.9210663, -2002.44739
elseif MOB == 'The Clown [Lv. 75]' then
_G.Qlvl = "QuestLvl75"
_G.Npcpos = 4264.86035, 9.82300854, 242.78186
elseif MOB == 'Captain [Lv. 120]' then
_G.Qlvl = "QuestLvl120"
_G.Npcpos = 1729.08826, 39.2150269, 1214.3562
elseif MOB == 'Axe-Hand [Lv. 145]' then
_G.Qlvl = "QuestLvl145"
_G.Npcpos = 1616.3252, 51.874794, 1399.22314
elseif MOB == 'Karate Fishman [Lv. 200]' then
_G.Qlvl = "QuestLvl200"
_G.Npcpos = 4131.34766, 10.548008, 3125.23584
elseif MOB == 'SharkMan [Lv. 230]' then
_G.Qlvl = "QuestLvl230"
_G.Npcpos = 4370.74951, 10.1640816, 3227.86353
elseif MOB == 'Weapon Man [Lv. 350]' then
_G.Qlvl = "QuestLvl350"
_G.Npcpos = -44.7108116, 49.7985001, 116.860809
elseif MOB == 'King Snow [Lv. 450]' then
_G.Qlvl = "QuestLvl450"
_G.Npcpos = -3029.46826, 17.8230724, 1422.38257
elseif MOB == 'Heavy Man [Lv. 500]' then
_G.Qlvl = "QuestLvl500"
_G.Npcpos = -2936.58618, 27.8160839, 1939.83276
elseif MOB == 'Bomb Man [Lv. 625]' then
_G.Qlvl = "QuestLvl625"
_G.Npcpos = 1479.20642, 10.8593578, 3618.57764
elseif MOB == 'King of Sand [Lv. 725]' then
_G.Qlvl = "QuestLvl725"
_G.Npcpos = 1571.41174, 43.9011383, 3689.43091
elseif MOB == 'Ball Man [Lv. 850]' then
_G.Qlvl = "QuestLvl850"
_G.Npcpos = 228.488007, 2701.8623, 4553.81006
elseif MOB == 'Rumble Man [Lv. 900]' then
_G.Qlvl = "QuestLvl900"
_G.Npcpos = 151.201431, 2701.8623, 4901.05078
elseif MOB == 'Leader [Lv. 1100]' then
_G.Qlvl = "QuestLvl1100"
_G.Npcpos = 8169.33984, 11.0420132, 5523.49121
elseif MOB == 'Pasta [Lv. 1150]' then
_G.Qlvl = "QuestLvl1150"
_G.Npcpos = 8257.38574, 11.041357, 6098.20703
elseif MOB == 'Wolf [Lv. 1250]' then
_G.Qlvl = "QuestLvl1250"
_G.Npcpos = 3683.99121, 10.6302509, 7099.52344
elseif MOB == 'Giraffe [Lv. 1325]' then
_G.Qlvl = "QuestLvl1325"
_G.Npcpos = 4062.1062, 10.6302509, 6858.09326
elseif MOB == 'Leo [Lv. 1400]' then
_G.Qlvl = "QuestLvl1400"
_G.Npcpos = 3758.69336, 10.6302509, 7282.73291
elseif MOB == 'Combat Fishman [Lv. 2050]' then
_G.Qlvl = "QuestLvl2050"
_G.Npcpos = 2782.10425, 40.3092194, 13619.3193
elseif MOB == 'Sword Fishman [Lv. 2100]' then
_G.Qlvl = "QuestLvl2100"
_G.Npcpos = 3298.78711, 40.3359528, 13792.8857
elseif MOB == 'Seasoned Fishman [Lv. 2200]' then
_G.Qlvl = "QuestLvl2200"
_G.Npcpos = 2786.54004, 40.3368225, 13819.1338
elseif MOB == 'Shadow Masdow [Lv. 1600]' then
_G.Qlvl = "QuestLvl1600"
_G.Npcpos = -723.612488, 83.6947708, 8362.14844
...
mobB = removeDuplicates(mobB)
for i = 1, #mobB do
    DD1:Add(mobB[i])
end
mobB = removeDuplicates(mobC)
for i = 1, #mobB do
    DD1:Add(mobB[i])
end
...
Tab:AddLabel('--- Auto Quest Is Soon ---')


--[[
local vu = game:service'VirtualUser'
if game.Players.LocalPlayer.CurrentQuest.MOB == "" then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2012.53516, 47.9210663, -1809.96167)
    wait(0.5)
    game:GetService("ReplicatedStorage").CheckQuest:InvokeServer(workspace.AntiTPNPC[_G.Qlvl])
    wait(1)
    for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui:GetChildren()) do
        if v.Name == _G.Qlvl then
            wait(1)
            game:GetService("Players").LocalPlayer.PlayerGui[_G.Qlvl].Dialogue:WaitForChild("Accept").Position = UDim2.new(-1.5,0,-3.5)
            game:GetService("Players").LocalPlayer.PlayerGui[_G.Qlvl].Dialogue:WaitForChild("Accept").Size = UDim2.new(35,35,35)
        end
    end
    wait(1)
...
local enabled = Tab:AddSwitch("Auto Farm", function(state)
    Enabled = state
    while Enabled do
        if Enabled and not Disabled then
            for i,v in pairs(game:service'ReplicatedStorage'["MOB"]:GetChildren()) do
                if Enabled and not Disabled and v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and v.Name == StatsDropDownValue2 then
                     if Enabled and not Disabled then
                        repeat wait()
                            pcall(function()
                                LocalP.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, -3, 0)

                            end)          
                            pcall(function()
                            if LocalP:FindFirstChild("Backpack"):FindFirstChild(ABC) then
                                    local tool = LocalP:WaitForChild("Backpack"):FindFirstChild(ABC)
                                    wait(.4)
...
local atqu = false
Tab:AddSwitch('AutoQuest', function(bool)
atqu = bool
end)
...
if game.Players.LocalPlayer.CurrentQuest.Value == "" then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = _G.Npcpos
    wait(0.5)
    game:GetService("ReplicatedStorage").CheckQuest:InvokeServer(workspace.AntiTPNPC[_G.Qlvl])
    wait(.3)
    for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui:GetChildren()) do
        if v.Name == _G.Qlvl then
            wait(0.3)
            game:GetService("Players").LocalPlayer.PlayerGui.QuestLvl1.Dialogue:WaitForChild("Accept").Position = UDim2.new(-1.5,0,-3.5)
            game:GetService("Players").LocalPlayer.PlayerGui.QuestLvl1.Dialogue:WaitForChild("Accept").Size = UDim2.new(35,35,35)
        end
    end
    wait(0.3)
atk()
...
local TpDF = false
		local Switch = Tab:AddSwitch("Tp Devil Fruits", function(bool)
    TpDF = bool
...
local StatsDropDownValue5;
local ABC = Tab:AddDropdown("Stats",function(MOB)
    StatsDropDownValue5 = MOB
    M = string.split(StatsDropDownValue5)
end)
for i, v in pairs(StatLists) do 
ABC:Add(tostring(v))
end
local Start5 = false
		local Switch = Tab:AddSwitch("Auto Stat", function(bool)
Start5 = bool
		end)
function AutoStat()
    pcall(function()
    	local plr = game.Players.LocalPlayer
		game:GetService("Players")[plr.Name].PlayerGui.Stats.Button.StatsFrame[StatsDropDownValue5].RemoteEvent:FireServer( game.Players[plr.Name].PlayerStats , 1)
    end)
end
...
local Skill = Window:AddTab("Skills")
...
local MousePosition = MouseCFrame.x

Skill:AddLabel("if don't have a tool pls unequip tool and execute again")
Skill:AddLabel("--- Presses ---")
local TWSASDAS = Skill:AddDropdown("Tool",function(T)
    tollslco = T
    Tool = string.split(tollslco)
end)
for i,v in ipairs(LocalP.Backpack:GetChildren()) do
    if v:IsA("Tool") then
        TWSASDAS:Add(v.Name)
...
for i2,v2 in pairs(LocalP.Character:GetChildren()) do
    if v2:IsA("Tool") then
        TWSASDAS:Add(v2.Name)
    end
end

Skill:AddSwitch("Auto Press Z Move", function(bool)
ZMoveTg = bool
while ZMoveTg do
	wait()


                            if LocalP:FindFirstChild("Backpack"):FindFirstChild(tollslco) then
                                    local toolss = LocalP:WaitForChild("Backpack"):FindFirstChild(tollslco)
                                    wait(.1)
                                    LocalP.Character.Humanoid:EquipTool(toolss)
                                end

local toasdasdasdol = LocalP.Character:FindFirstChildOfClass("Tool")
for i,v in pairs (toasdasdasdol:GetChildren()) do
if v:IsA('RemoteEvent') and v.Name == "Z" then

	v:FireServer({[1] = CFrame.new(Mouse.Hit.p)})

end
end
end
		end)
Skill:AddSwitch("Auto Press X Move", function(bool)
XMoveTg = bool
while XMoveTg do
	wait()
...
local toasdasdasdol = LocalP.Character:FindFirstChildOfClass("Tool")
for i,v in pairs (toasdasdasdol:GetChildren()) do
if v:IsA('RemoteEvent') and v.Name == "X" then
...
Skill:AddSwitch("Auto Press C Move", function(bool)
CMoveTg = bool
while CMoveTg do
	wait()
...
local toasdasdasdol = LocalP.Character:FindFirstChildOfClass("Tool")
for i,v in pairs (toasdasdasdol:GetChildren()) do
if v:IsA('RemoteEvent') and v.Name == "C" then
...
Skill:AddSwitch("Auto Press V Move", function(bool)
VMoveTg = bool
while VMoveTg do
	wait()
...
local toasdasdasdol = LocalP.Character:FindFirstChildOfClass("Tool")
for i,v in pairs (toasdasdasdol:GetChildren()) do
if v:IsA('RemoteEvent') and v.Name == "V" then
...
Skill:AddSwitch("Auto Press B Move", function(bool)
BMoveTg = bool
while BMoveTg do
	wait()
...
local time = 2
		...
		local slider = Skill:AddSlider("Time To Hold", function(p)
			time = p
		end, {
			["min"] = 1,
			["max"] = 10,
...
Skill:AddSwitch("Auto Hold Z Move", function(bool)
ZHoldTg = bool
while ZHoldTg do
	wait()
...
Skill:AddSwitch("Auto Hold X Move", function(bool)
XHoldTg = bool
		end)
Skill:AddSwitch("Auto Hold C Move", function(bool)
CHoldTg = bool
while CHoldTg do
	wait()
...
Skill:AddSwitch("Auto Hold V Move", function(bool)
VHoldTg = bool
while VHoldTg do
	wait()
...
Skill:AddSwitch("Auto Hold B Move", function(bool)
BHoldTg = bool
while BHoldTg do
	wait()
...
if v:IsA('RemoteEvent') and v.Name == "B" then
	...
	v:FireServer("Up")
		...
		Skill:AddLabel('--- Other ---')
		local Switch = Skill:AddSwitch("Anti Swim Damage", function(bool)
_G.Swin = bool
...
local Switch = Skill:AddSwitch("No Cooldown Geppo", function(bool)
_G.Gppor = bool
...
game:GetService("Players").LocalPlayer.Backpack.GeppoNew.cds.Value = 7
		...
		local Switch = Skill:AddSwitch("No Cooldown Soru", function(bool)
_G.Sour = bool
...
local r = Window:AddTab('Raid Farm')
...
local IsTP = tp:AddDropdown("Select Islands", function(value)

	if value == "Starter Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2070.98486, 50.9848671, -1852.43359)

	elseif value == "Pirate Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3881.25293, 10.0470552, 125.63192)
		
		elseif value == "Soldier Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1858.04761, 14.1635742, 1129.36511)
		
				elseif value == "Shark Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3928.99194, 11.3548536, 3169.20166)
		
				elseif value == "Chef Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-27.4000778, 99.4454575, 84.2155609)
		
				elseif value == "Snow Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2948.53198, 29.2295723, 1971.3418)
		
				elseif value == "Desert Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1851.79456, 10.859355, 3604.25928)
		
				elseif value == "Sky Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(231.852386, 2701.86157, 4779.6084)
		
						elseif value == "Bubble Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8173.52686, 11.0420103, 5678.24365)
		
				elseif value == "Lobby Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3818.87695, 17.6887608, 6403.6709)
		
				elseif value == "Zombie Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1084.96448, 226.772903, 8384.30664)
		
				elseif value == "War Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8414.39258, 51.512619, 1107.78699)
		
				elseif value == "Fish Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3552.84277, 7.34229708, 13573.9932)
		
				elseif value == "Rock Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(6231, 3.74830532, -2014)
		
				elseif value == "Stone Island" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(9600, 17.5219936, -3899)
	end
end)
IsTP:Add("Starter Island")
IsTP:Add("Pirate Island")
IsTP:Add("Soldier Island")
IsTP:Add("Shark Island")
IsTP:Add("Chef Island")
IsTP:Add("Snow Island")
IsTP:Add("Desert Island")
IsTP:Add("Sky Island")
IsTP:Add("Lobby Island")
IsTP:Add("Zombie Island")
IsTP:Add("War Island")
IsTP:Add("Fish Island")
IsTP:Add("Rock Island")
IsTP:Add("Stone Island")


local NpcTP = tp:AddDropdown("Select NPCS", function(value)

	if value == "Black Market" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2189.46606, 79.9244614, -1729.55359)

	elseif value == "Fruit Random" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2274.99463, 47.9210548, -1652.00977)
		
		elseif value == "Soru" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1880, 14.1538038, 1151.00012)
		
				elseif value == "Buso Haki" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8211, 11.5367756, 5720)
		
				elseif value == "Ken Haki" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(175, 2703.07373, 4735)
		
				elseif value == "Katana" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(198, 2701.8623, 4826)
		
				elseif value == "Shark Blade" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(4395, 10.8077717, 2967)
		
				elseif value == "Bisento" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1444.99988, 92.8760223, 3982.00024)
		
				elseif value == "Pipe" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8266, 11.0420103, 5568)
		
				elseif value == "Triple Katana" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(6528.25537, 189.603867, -1913.3811)
		
				elseif value == "KaidoMace" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1609.19946, 43.9012375, 3657.51904)
		
				elseif value == "Dark Leg" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(6435.99951, 98.9523544, -2338.99976)
		
				elseif value == "Cyborg" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(4610.19238, 10.1620045, 3044.93164)
		
				elseif value == "Water Style" then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2861.67603, 40.3334656, 14146.3379)
	end
end)
NpcTP:Add("Black Market")
NpcTP:Add("Fruit Random")
NpcTP:Add("Soru")
NpcTP:Add("Buso Haki")
NpcTP:Add("Ken Haki")
NpcTP:Add("Katana")
NpcTP:Add("Shark Blade")
NpcTP:Add("Bisento")
NpcTP:Add("Pipe")
NpcTP:Add("Triple Katana")
NpcTP:Add("Dark Leg")
NpcTP:Add("Cyborg")
NpcTP:Add("Water Style")
--[[
tp:AddButton('cop',function()
setclipboard(tostring(game.Workspace.Farn2000.HumanoidRootPart.Position))
end)]]



		local TabM = Window:AddTab("Misc")
		local cc = TabM:AddButton("LShift click tp",function()
