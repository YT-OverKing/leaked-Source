...
Tab:AddLabel("--- When Auto Farm Is Enable Pls RShift For Auto Attack :V ---")
...
local Start = false
		...
		local ATF = Tab:AddSwitch("Auto Farm (Instant Kill)", function(bool)
			Start = bool
		end)

function autofarm()
    pcall(function()
            for i = 1,#game.Workspace.Enemies:GetChildren() do local v = game.Workspace.Enemies:GetChildren()[i]
                if v.Name == M[1] and v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then 
                    repeat wait()
                    
                        pcall(function()
                        game.Players.LocalPlayer.Character:WaitForChild('HumanoidRootPart').CFrame = v.PrimaryPart.CFrame + (v.PrimaryPart.CFrame.lookVector * (-10))
                        wait(0.1)
                        v.Humanoid.Health = 0
                        wait(0.1)
game.Players.LocalPlayer.Character:WaitForChild('HumanoidRootPart').CFrame = v.PrimaryPart.CFrame + (v.PrimaryPart.CFrame.lookVector * (-0))
...
local asasdasd = false

		local ATF = Tab:AddSwitch("Auto Kill All (Instant Kill) --Unstable", function(bool)
			asasdasd = bool
		end)
...
function autofarmall()
    pcall(function()
            for i = 1,#game.Workspace.Enemies:GetChildren() do local v = game.Workspace.Enemies:GetChildren()[i]
                if v.Name == M[i] and v:FindFirstChild('Humanoid') and v:FindFirstChild('HumanoidRootPart') and v.Humanoid.Health > 0 then 
                    repeat wait(0.3)
                        pcall(function()
                        game.Players.LocalPlayer.Character:WaitForChild('HumanoidRootPart').CFrame = v.PrimaryPart.CFrame + (v.PrimaryPart.CFrame.lookVector * (-10))
                        wait(0.2)
...
spawn(function()
    while game:GetService("RunService").Heartbeat:wait() do
        pcall(function()
            if Start then
                plr.Character.HumanoidRootPart.Status:Destroy()
...
local ABCD = Tab:AddDropdown("Tool For Auto Click",function(ToolA)
    ABCDEFG = ToolA
    Tool = string.split(ABCDEFG)
end)
for i, v in pairs(Tool) do 
ABCD:Add(tostring(v))
end
function autoeq()
    pcall(function()
       	game.Players.LocalPlayer.Backpack:FindFirstChild(ABCDEFG).Parent = game.Players.LocalPlayer.Character
    end)
end

local ATTK = false

		local ATTTH = Tab:AddSwitch("Auto Click", function(bool)
			ATTK = bool
		end)
...
--[[local fruitname;
Tab:AddTextBox('Devil Fruit Name', function(ff)
fruitname = ff
end)]]

--[[Tab:AddButton('Change df', function()
game.Workspace:WaitForChild(game.Players.LocalPlayer.Name).DevilFruit.Value = (fruitname)
game.Workspace.UserData:FindFirstChild("User_"..game.Players.LocalPlayer.UserId).Data.DevilFruit.Value = fruitname
end)]]

	local d = Window:AddTab("Dupe Tools")
d:AddButton('Dupe All Tool', function()
game:GetService("Workspace")[plr.LocalPlayer.Name].Weapons:FireServer()
end)

d:AddSwitch('Auto Dupe All Tool', function(bool)
_G.Duoeall = bool
while _G.Duoeall do
wait()
game:GetService("Workspace")[plr.LocalPlayer.Name].Weapons:FireServer()
...
local AUTOASDAIDS;
local ASDASDASD = d:AddDropdown("Tool Select",function(asdasdasd)
    AUTOASDAIDS = asdasdasd
    Tool = string.split(AUTOASDAIDS)
end)
for i, v in pairs(Tool) do 
ASDASDASD:Add(tostring(v))
end

local eapsdapsd = false
d:AddSwitch('Auto Equip Dupe Tool --Unstable', function(bool)
eapsdapsd = bool
end)
local asdasdasdaasdasdasdaasdasdasda = false
d:AddSwitch('Auto Click', function(bool)
asdasdasdaasdasdasdaasdasdasda = bool
end)
...
wait(.2)
game.Players.LocalPlayer.Backpack:FindFirstChild(AUTOASDAIDS).Parent = game.Players.LocalPlayer.Character
wait(.1)
game.Players.LocalPlayer.Character:FindFirstChild(AUTOASDAIDS).Parent = game.Players.LocalPlayer.Backpack
wait(.1)
end
    end)
end
...
spawn(function()
    while wait() do
        if asdasdasdaasdasdasdaasdasdasda then
            autoatk()
        end
    end
end)
...
local FistWaterFistWaterFistWater = Buy:AddDropdown("Water Select",function(FistWaterAAA)
    FistWater = FistWaterAAA
    waterlist = string.split(FistWater)
end)
for i, v in pairs(waterlist) do 
FistWaterFistWaterFistWater:Add(tostring(v))
end

		local ATTTH = Buy:AddSwitch("Auto Buy Water", function(bool)
			_G.First = bool
			while _G.First do
			wait()
			--['BetterDrinkMerchant' or 'DrinkMerchant']
game:GetService("Workspace").Merchants['DrinkMerchant'].Clickable.Retum:FireServer(FistWater)
...
local FistWaterFistWaterFistWater = Buy:AddDropdown("Water Select",function(FistWaterAAasdasA)
    SecWater = FistWaterAAasdasA
    waterlist2 = string.split(SecWater)
end)
for i, v in pairs(waterlist2) do 
FistWaterFistWaterFistWater:Add(tostring(v))
end
		...
		local ATTTH = Buy:AddSwitch("Auto Buy Water", function(bool)
			...
			wait()
			--['BetterDrinkMerchant' or 'DrinkMerchant']
game:GetService("Workspace").Merchants['BetterDrinkMerchant'].Clickable.Retum:FireServer(SecWater)
		...
		local ABVC = Window:AddTab("Grab")
ABVC:AddButton('Chests (Soon)',function()

end)
ABVC:AddButton('Devil Fruits (Soon)',function()

for _,v in pairs(game.Workspace:GetChildren()) do
if v.Name:match("Fruit") and v:IsA("Tool") then
...
ABVC:AddButton('Foods',function()

    local t = {}
    local plrs = game:service'Players'.LocalPlayer
    for i,v in pairs(workspace:GetChildren()) do 
        spawn(function()
            if v.Name == "Cantaloupe" then
            v.Handle.CFrame = plrs.Character.HumanoidRootPart.CFrame
            end
            if v.Name == "Melon" then
            v.Handle.CFrame = plrs.Character.HumanoidRootPart.CFrame
            end
...
ABVC:AddSwitch('Auto Grab Chests (Soon)',function(bool)
_G.Ch = bool
while _G.Ch do
wait()
...
ABVC:AddSwitch('Auto Grab Devil Fruits (Soon)',function(bool)
_G.DF = bool
while _G.DF do
wait()
for _,v in pairs(game.Workspace:GetChildren()) do
...
ABVC:AddSwitch('Auto Grab Foods',function(bool)
_G.Food = bool
while _G.Food do
wait()
    local t = {}
...
ABVC:AddLabel('Daily and Hourly Box')

ABVC:AddSwitch('Auto Claim Daily Gem',function(bool)
_G.Ch = bool
while _G.Ch do
wait()

game:GetService("Workspace").UserData["User_" .. game.Players.LocalPlayer.UserId].ClaimRewardDaily:FireServer('RewardMark')
end
end)

ABVC:AddSwitch('Auto Claim Hourly Beli',function(bool)
_G.Hl = bool
while _G.Hl do
wait()
game:GetService("Workspace").UserData["User_" .. game.Players.LocalPlayer.UserId].ClaimRewardHourly:FireServer('RewardMark')

end
end)


		local SamT = Window:AddTab("Sam Quest")
--[[local tiner = true

function Timer()
    pcall(function()
		local sanpat = game:GetService("Players").LocalPlayer.PlayerGui.Menu.Frame.C.Frame.A.Sam.SamTimer.Text
		_G.Text = "Sam's Quest : " .. sanpat
    end)
end
...
Timer()
		...
		SamT:AddLabel(_G.Text)]]
		
SamT:AddSwitch('Auto Accept Sam Quest',function(bool)
_G.SamAcc = bool
while _G.SamAcc do
wait()
...
SamT:AddButton('Open Sam Quest',function(bool)
...
v.Parent = game.Players.LocalPlayer.Character
		...
		local c = Window:AddTab("Clothing")
c:AddSwitch('Rainbow Clothing',function(bool)
	_G.Rainbow = bool
	while _G.Rainbow do
		wait()
...
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Hair_Color']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Torso_Color']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Arms_Color']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Legs_Color']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Hands_Color']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Face_Color']:FireServer(unpack(args))


	end
end)

c:AddSwitch('Random Clothing',function(bool)
	_G.Random = bool
	while _G.Random do
		wait()
local args = {
...
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Hair']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Torso']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Arms']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Legs']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Hands']:FireServer(unpack(args))
workspace.UserData["User_" .. game.Players.LocalPlayer.UserId]['UpdateClothing_Face']:FireServer(unpack(args))
	end
end)
...
local cc = TabM:AddButton("Ctrl click tp",function()
