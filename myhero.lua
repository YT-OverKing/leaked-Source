...
do -- Example UI
	local Window = library:AddWindow("Boku No Roblox: Remastered", {
		main_color = Color3.fromRGB(41, 74, 122),
...
local path = game:GetService("Workspace").Others.NPCSpawns:GetChildren()
local path2 = game:GetService("ReplicatedStorage").Package.Quests:GetChildren()
local FPath = game:GetService("Workspace").Living:GetChildren()
local ID = game.Players.LocalPlayer.UserId
-- Grabs  NPCS
for i = 1,#path do local v = path[i]
...
-- Grab Quests
for i = 1,#path2 do local v = path2[i]
    if not table.find(QC, v.Name)then 
        table.insert(QC, v.Name) 
    end 
end 

local StatsDropDownValue;
local ATS = Tab:AddDropdown("Stats",function(EZ)
...
ATS:Add("Defense")
ATS:Add('Energy')
local ATS = Tab:AddSwitch("Auto Stats", function(bool)
    _G.on2 = bool
    while _G.on2 do
        wait()
        game:GetService("ReplicatedStorage").Package.Events.Point:InvokeServer(StatsDropDownValue,"1")
    end
end)

local StatsDropDownValue2;
local ATF = Tab:AddDropdown("Mob",function(ATF)
    StatsDropDownValue2 = ATF
...
local StatsDropDownValue3;
local ATQ = Tab:AddDropdown("Quest",function(ATQ)
    StatsDropDownValue3 = ATQ
    Q = string.split(StatsDropDownValue3)
    
end)
for i, v in pairs(QC) do 
ATQ:Add(tostring(v))
end

local ATFTG = false
local ATF2 = Tab:AddSwitch('Auto Farm', function(bool)
	ATFTG = bool
end)
...
function autofarm()
    pcall(function()
            for i = 1,#game.Workspace.Living:GetChildren() do local v = game.Workspace.Living:GetChildren()[i]
...
game:GetService("ReplicatedStorage").Package.Events.Combat:FireServer(1, CFrame.new(v.PrimaryPart.Position))
wait()
game:GetService("ReplicatedStorage").Package.Events.Combat:FireServer(2, CFrame.new(v.PrimaryPart.Position))
wait()
game:GetService("ReplicatedStorage").Package.Events.Combat:FireServer(3, CFrame.new(v.PrimaryPart.Position))
wait()
game:GetService("ReplicatedStorage").Package.Events.Combat:FireServer(4, CFrame.new(v.PrimaryPart.Position))
wait()
game:GetService("ReplicatedStorage").Package.Events.Combat:FireServer(5, CFrame.new(v.PrimaryPart.Position))
wait()
                    until not v:FindFirstChild('Humanoid') or v.Humanoid.Health <=0 or v:FindFirstChild('HumanoidRootPart') or v.Parent == nil or v.HumanoidRootPart.Parent == nil
                end 
    end 
    end)
end
function autoquest()
    pcall(function()
   if game:GetService("ReplicatedStorage").Datas[ID].QuestProgress.Value == 0 then 
     game:GetService("ReplicatedStorage").Package.Events.GetQuest:InvokeServer(StatsDropDownValue3)
     game:GetService("Players").Farn2000.PlayerGui.HUD.Frames.Quest.Visible = true
   end
  end)
end 
spawn(function()
...
Tab:AddButton('Hide Name',function(bool)
...
v:Destroy()
		...
		local TabS = Window:AddTab("Move")
		
local AutoSkill1 = false
TabS:AddSwitch('Auto Skill 1', function(bool)
	AutoSkill1 = bool
end)

local AutoSkill2 = false
TabS:AddSwitch('Auto Skill 2', function(bool)
	AutoSkill2 = bool
end)

local AutoSkill3 = false
TabS:AddSwitch('Auto Skill 3', function(bool)
	AutoSkill3 = bool
end)

local AutoSkill4 = false
TabS:AddSwitch('Auto Skill 4', function(bool)
	AutoSkill4 = bool
end)

local AutoSkill5 = false
TabS:AddSwitch('Auto Skill 5', function(bool)
	AutoSkill5 = bool
end)

function AutoSkill1F()
    pcall(function()
game:GetService("ReplicatedStorage").Package.Events.Skill:InvokeServer("1","Down", {["MouseHit"] = CFrame.new(1317.87915, -2497.74609, -10278.8633, 0.993611872, 0.0292075519, -0.109006397, -0, 0.965927303, 0.258813918, 0.112851553, -0.257160574, 0.959756792), ["Mobile"] = false})
  end)
end 
spawn(function()
    while wait() do
...
function AutoSkill2F()
    pcall(function()
game:GetService("ReplicatedStorage").Package.Events.Skill:InvokeServer("2","Down", {["MouseHit"] = CFrame.new(1317.87915, -2497.74609, -10278.8633, 0.993611872, 0.0292075519, -0.109006397, -0, 0.965927303, 0.258813918, 0.112851553, -0.257160574, 0.959756792), ["Mobile"] = false})
  end)
end 
spawn(function()
    while wait() do
...
function AutoSkill3F()
    pcall(function()
game:GetService("ReplicatedStorage").Package.Events.Skill:InvokeServer("3","Down", {["MouseHit"] = CFrame.new(1317.87915, -2497.74609, -10278.8633, 0.993611872, 0.0292075519, -0.109006397, -0, 0.965927303, 0.258813918, 0.112851553, -0.257160574, 0.959756792), ["Mobile"] = false})
  end)
end 
spawn(function()
    while wait() do
...
function AutoSkill4F()
    pcall(function()
game:GetService("ReplicatedStorage").Package.Events.Skill:InvokeServer("4","Down", {["MouseHit"] = CFrame.new(1317.87915, -2497.74609, -10278.8633, 0.993611872, 0.0292075519, -0.109006397, -0, 0.965927303, 0.258813918, 0.112851553, -0.257160574, 0.959756792), ["Mobile"] = false})
  end)
end 
spawn(function()
    while wait() do
...
function AutoSkill5F()
    pcall(function()
game:GetService("ReplicatedStorage").Package.Events.Skill:InvokeServer("5","Down", {["MouseHit"] = CFrame.new(1317.87915, -2497.74609, -10278.8633, 0.993611872, 0.0292075519, -0.109006397, -0, 0.965927303, 0.258813918, 0.112851553, -0.257160574, 0.959756792), ["Mobile"] = false})
  end)
end 
spawn(function()
    while wait() do
...
Teleport()
		...
		local Cr = Window:AddTab("Credits") -- This can contain exactly the same as a Tab. You can have as many folders as you'd like to.
		Cr:AddLabel("Creator Discord : ! X x ShuShi x X !#0059")
